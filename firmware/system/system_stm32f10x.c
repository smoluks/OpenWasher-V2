...
void SystemInit(void) {
	...
	RCC->APB2ENR = RCC_APB2ENR_ADC1EN | RCC_APB2ENR_IOPAEN | RCC_APB2ENR_IOPBEN	| RCC_APB2ENR_IOPCEN | RCC_APB2ENR_USART1EN | RCC_APB2ENR_AFIOEN| RCC_APB2ENR_ADC2EN;
	RCC->APB1ENR = RCC_APB1ENR_I2C2EN | RCC_APB1ENR_PWREN | RCC_APB1ENR_TIM2EN | RCC_APB1ENR_TIM3EN	| RCC_APB1ENR_TIM4EN;
